...
// list of accepted types --- need to rearrange, need to have shortest first
static vector< string > accept_types[] = {
{"unsigned int "}, 
...
/**
 *	Checks to see if we can find the type of the symbol (variable)
 *
 * 	@param line: The source code line
 * 	@return Index of the type
 */
 /*
int can_find_type( string line ) {
	for ( int i = 0; i < accept_types.size(); ++i )
		if ( line.find(accept_types[i]) != -1 )
			return i;
