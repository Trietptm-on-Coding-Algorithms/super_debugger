...
int main() {
	...
	*/
	...
	cout << "\e[1mThis should appear after\e[0m\n";
	cout << "\e[1mthe first breakpoint\e[0m\n";
	
	
	cout << "\e[1mTesting breakpoint in a for loop (sum from 1 to 10)\e[0m\n";
	int sum = 0;
	for (int i = 0; i < 10; ++i)
		sum += i;
		
	cout << "\e[1mSum is: " << sum << "\e[0m\n";
	
	cout << "\e[1mTesting third 'set' breakpoint\e[0m\n";
	
	cout << "\e[1mThis should appear after third breakpoint\e[0m\n";
	
	cerr << "\e[1mWill this appear?\e[0m\n";
/*	
